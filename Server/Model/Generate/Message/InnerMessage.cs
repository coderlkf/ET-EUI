...
namespace ET
{
	...
	[ResponseType(nameof(G2L_DisconnectionGateUnit))]
	[Message(InnerOpcode.L2G_DisconnectionGateUnit)]
	[ProtoContract]
	public partial class L2G_DisconnectionGateUnit: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2L_DisconnectionGateUnit)]
	[ProtoContract]
	public partial class G2L_DisconnectionGateUnit: Object, IActorResponse
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
